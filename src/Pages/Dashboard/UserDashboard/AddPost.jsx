...
const customSelectStyles = {
  ...
  option: (provided, state) => {
    ...
    return {
      ...
      color: state.isSelected ? 'white' : state.isFocused ? '#4f46e5' : '#1f2937',
      cursor: 'pointer',
...
const AddPost = () => {
  ...
  if (badge === 'Bronze Badge' && postCount >= 5) {
    return (
      <section className="max-w-xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden mt-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="mt-1 flex items-center">
              <div className="relative group">
                <div className={`w-24 h-24 rounded-full overflow-hidden border-2 border-dashed ${authorImage ? 'border-transparent' : 'border-indigo-300 group-hover:border-indigo-400'} transition-colors duration-300 flex items-center justify-center bg-gray-50`}>
                  {authorImage ? (
                    <img
                      src={authorImage}
                      alt="Author preview"
                    ...
                    <svg
                      className="h-12 w-12 text-indigo-300 group-hover:text-indigo-400 transition-colors duration-300"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
              ...
              <div className="ml-4">
                <label className="cursor-pointer">
                  <div className="px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg transition-colors duration-300 text-sm font-medium">
                    {isUploading ? (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  readOnly
                  className="block w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`block w-full px-4 py-3 rounded-lg border ${errors.title ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-indigo-500 focus:border-indigo-500'} shadow-sm`}
          ...
          <div>
            ...
            <div className="relative">
              <textarea
                ...
                className={`block w-full px-4 py-3 rounded-lg border ${errors.description ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-200 focus:ring-indigo-500 focus:border-indigo-500'} shadow-sm`}
          ...
          <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${badge === 'Bronze Badge' ? 'bg-amber-100 text-amber-800' : 'bg-purple-100 text-purple-800'}`}>
                  {badge}
                </span>
              </div>
              <div className="ml-3">
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-lg font-medium text-white ${isSubmitting ? 'bg-indigo-400' : 'bg-indigo-600 hover:bg-indigo-700'} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-300`}
            >
              {isSubmitting ? (
                <>
